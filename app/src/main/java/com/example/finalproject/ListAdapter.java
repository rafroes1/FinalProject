...
public class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ListAdapter(List<House> list, OnRowCallBack onRowCallBack, Context context) {
        super();
        mList = list;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView txtStreetAdress, txtDescription;
        public ViewHolder(View itemView){
            super(itemView);
            //find widget by id
            txtStreetAdress = (TextView) itemView.findViewById(R.id.txtStreetAdress);
